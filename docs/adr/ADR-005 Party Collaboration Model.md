...
This ADR describes a later collaboration model. The current app provides party visibility and shared campaign utilities, but it does not yet establish Party as a complete independent domain with the lifecycle described below.
