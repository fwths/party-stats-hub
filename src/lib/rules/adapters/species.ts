...
export function speciesToRuleChoicesAndGrants(speciesEntity: any): {
  ...
  if (
    proficienciesJson &&
    proficienciesJson.starting &&
    Array.isArray(proficienciesJson.starting.toolProficiencies)
  ) {
  ...
  // Features
  const featuresJson = parseJsonValue(
    speciesEntity.featuresJson || speciesEntity.features_json,
    [],
  );
...
function addLegacySpeciesTraits(
      ...
      options: [
        {
          ...
          grants: [
            {
              id: `${sourceEntity}_drow_sense`,
              type: "sense",
              value: { Darkvision: 120 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_drow_cantrip`,
              type: "spell_known",
              value: { name: "Dancing Lights", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_drow_spell_3`,
              type: "spell_known",
              value: { name: "Faerie Fire", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 3,
            ...
            {
              id: `${sourceEntity}_drow_spell_5`,
              type: "spell_known",
              value: { name: "Darkness", level: 2 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 5,
        ...
        },
        {
          ...
          grants: [
            {
              id: `${sourceEntity}_high_cantrip`,
              type: "spell_known",
              value: { name: "Prestidigitation", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_high_spell_3`,
              type: "spell_known",
              value: { name: "Detect Magic", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 3,
            ...
            {
              id: `${sourceEntity}_high_spell_5`,
              type: "spell_known",
              value: { name: "Misty Step", level: 2 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 5,
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_wood_cantrip`,
              type: "spell_known",
              value: { name: "Druidcraft", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_wood_spell_3`,
              type: "spell_known",
              value: { name: "Longstrider", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 3,
            ...
            {
              id: `${sourceEntity}_wood_spell_5`,
              type: "spell_known",
              value: { name: "Pass without Trace", level: 2 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 5,
      ...
      options: [
        {
          ...
          grants: [
            {
              id: `${sourceEntity}_forest_cantrip`,
              type: "spell_known",
              value: { name: "Minor Illusion", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_forest_spell`,
              type: "spell_known",
              value: { name: "Speak with Animals", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 1,
            ...
            {
              id: `${sourceEntity}_forest_feature`,
              type: "feature_reference",
              value: {
        ...
        },
        {
          ...
          grants: [
            {
              id: `${sourceEntity}_rock_cantrip1`,
              type: "spell_known",
            ...
            {
              id: `${sourceEntity}_rock_cantrip2`,
              type: "spell_known",
              value: { name: "Prestidigitation", level: 0 },
              mode: "fixed",
              sourceEntity,
      ...
      options: [
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_abyssal_can`,
              type: "spell_known",
              value: { name: "Poison Spray", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_abyssal_sp3`,
              type: "spell_known",
              value: { name: "Ray of Sickness", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 3,
            ...
            {
              id: `${sourceEntity}_abyssal_sp5`,
              type: "spell_known",
              value: { name: "Hold Person", level: 2 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 5,
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_chthonic_can`,
              type: "spell_known",
              value: { name: "Chill Touch", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_chthonic_sp3`,
              type: "spell_known",
              value: { name: "False Life", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 3,
            ...
            {
              id: `${sourceEntity}_chthonic_sp5`,
              type: "spell_known",
              value: { name: "Ray of Enfeeblement", level: 2 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 5,
            ...
            {
              id: `${sourceEntity}_chthonic_feat`,
              type: "feature_reference",
              value: {
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_infernal_can`,
              type: "spell_known",
              value: { name: "Fire Bolt", level: 0 },
              mode: "fixed",
              sourceEntity,
              provenance,
            },
            {
              id: `${sourceEntity}_infernal_sp3`,
              type: "spell_known",
              value: { name: "Hellish Rebuke", level: 1 },
              mode: "fixed",
              sourceEntity,
              provenance,
              level: 3,
            ...
            {
              id: `${sourceEntity}_infernal_feat`,
              type: "feature_reference",
              value: {
      ...
      options: [
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_black_feat`,
              type: "feature_reference",
              value: {
                name: "Draconic Ancestry: Black",
                description: "Breath Weapon and resistance use Acid damage.",
                source: "race",
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_blue_feat`,
              type: "feature_reference",
              value: {
                name: "Draconic Ancestry: Blue",
                description: "Breath Weapon and resistance use Lightning damage.",
                source: "race",
                sourceName: "Dragonborn",
                level: 1,
              },
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_brass_feat`,
              type: "feature_reference",
              value: {
                name: "Draconic Ancestry: Brass",
                description: "Breath Weapon and resistance use Fire damage.",
                source: "race",
                sourceName: "Dragonborn",
                level: 1,
              },
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_green_feat`,
              type: "feature_reference",
              value: {
                name: "Draconic Ancestry: Green",
                description: "Breath Weapon and resistance use Poison damage.",
                source: "race",
                sourceName: "Dragonborn",
                level: 1,
              },
        ...
        },
        {
          ...
          grants: [
            ...
            {
              id: `${sourceEntity}_silver_feat`,
              type: "feature_reference",
              value: {
                name: "Draconic Ancestry: Silver",
                description: "Breath Weapon and resistance use Cold damage.",
                source: "race",
                sourceName: "Dragonborn",
                level: 1,
              },
  ...
  if (raceId === "goliath") {
    choices.push({
      ...
      optionType: "feature",
      provenance,
      options: ["Cloud", "Fire", "Frost", "Hill", "Stone", "Storm"].map((giant) => ({
        id: giant.toLowerCase(),
        label: giant,
        description: `${giant} giant ancestry selected.`,
        grants: [
          {
            id: `${sourceEntity}_${giant.toLowerCase()}_feat`,
            type: "feature_reference",
            value: {
              name: `Giant Ancestry: ${giant}`,
              description: `${giant} selected.`,
              source: "race",
              sourceName: "Goliath",
              level: 1,
            },
  ...
  if (raceId === "shifter") {
    choices.push({
      ...
      optionType: "feature",
      provenance,
      options: ["Beasthide", "Longtooth", "Swiftstride", "Wildhunt"].map((form) => ({
        id: form.toLowerCase(),
        label: form,
        description: `${form} shifting form selected.`,
        grants: [
          {
            id: `${sourceEntity}_${form.toLowerCase()}_feat`,
            type: "feature_reference",
            value: {
              name: `Shifting: ${form}`,
              description: `${form} benefit selected.`,
              source: "race",
              sourceName: "Shifter",
              level: 1,
            },
