...
export const spells: SRDSpell[] = [
  ...
  },
  {
    ...
    school: "Conjuration",
    castingTime:
      "1 bonus action, which you take immediately after hitting a creature with a Melee weapon or an Unarmed Strike",
    range: "Self",
    components: "V",
    duration: "#Concentration, up to 1 minute",
    description:
  ...
  },
  {
    ...
    duration: "Concentration, up to 10 minutes",
    description:
      "You establish a telepathic link with one beast you touch that is friendly to you or charmed by you. The spell fails if the beast's Intelligence score is 4 or higher. Until the spell ends, the link is active while you and the beast are within line of sight of each other. Through the link, the beast can understand your telepathic messages to it, and it can telepathically communicate basic emotions and concepts back to you. While the link is active, the beast gains advantage on attack rolls against any creature within 5 feet of you that you can see.",
    classes: ["druid", "ranger"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "You create a blade-shaped rift in space and time. The blade appears in an unoccupied space of your choice within range. When you cast the spell, you can make up to two melee spell attacks with the blade, each against a creature, loose object, or structure within 5 feet of the blade. On a hit, the target takes 4d12 force damage. This attack scores a critical hit if the number on the d20 is 18 or higher. On a critical hit, the blade deals an extra 8d12 force damage (for a total of 12d12). As a bonus action on your turn, you can move the blade up to 30 feet and repeat the attacks.",
    classes: ["sorcerer", "warlock", "wizard"],
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You perform one of several religious ceremonies (Atonement, Bless Water, Coming of Age, Dedication, Funeral Rite, Wedding). When you cast the spell, choose one such ceremony, the target of which must be within 10 feet of you throughout the casting.",
    classes: ["cleric", "paladin"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You hurl an undulating, warbling mass of chaotic energy at one creature in range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 + 1d6 damage. Choose one of the d8s. The number rolled on that die determines the attack's damage type. If you roll the same number on both d8s, the chaotic energy leaps from the target to a different creature of your choice within 30 feet of it.",
    classes: ["sorcerer"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    description:
      "You choose nonmagical flame that you can see within range and that fits within a 5-foot cube. You affect it in one of the following ways: expand it, extinguish it, change its brightness/color, or cause simple shapes to appear within it.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 hour",
    description:
      "You take control of the air in a 100-foot cube that you can see within range. Choose one of the following effects when you cast the spell: Gusts, Downdraft, or Updraft. The effect lasts for the spell's duration.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "While speaking an intricate incantation, you cut yourself with a jewel-encrusted dagger, taking 2d4 piercing damage that can't be reduced in any way. You then drip your blood on the other spell components and touch them, transforming them into a special construct called a homunculus.\nThe statistics of the homunculus are in the Monster Manual. It is your faithful companion, and it dies if you die. Whenever you finish a long rest, you can spend up to half your Hit Dice if the homunculus is on the same plane of existence as you. When you do so, roll each die and add your Constitution modifier to it. Your hit point maximum is reduced by the total, and the homunculus's hit point maximum and current hit points are both increased by that much. This process can reduce you to no lower than 1 hit point, and the change to your and the homunculus's hit points ends when you finish your next long rest. The reduction to your hit point maximum can't be removed by any means before then, except by the homunculus's death.\nYou can have only one homunculus at a time. If you cast this spell while your homunculus lives, the spell fails.",
    classes: ["wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "1 hour",
    description:
      "Seven star-like motes of light appear and orbit your head until the spell ends. As a bonus action, you can send one of the motes streaking toward one creature or object within 120 feet of you. Make a ranged spell attack. On a hit, the target takes 4d12 radiant damage.",
    classes: ["sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "The light of dawn shines down on a location you specify within range. Until the spell ends, a 30-foot-radius, 40-foot-high cylinder of bright light glimmers there. Each creature in the cylinder must make a Constitution saving throw, taking 4d10 radiant damage on a failed save.",
    classes: ["cleric", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "You touch one willing creature and imbue it with the power to spew magical energy from its mouth, provided it has one. Choose acid, cold, fire, lightning, or poison. Until the spell ends, the creature can use an action to exhale energy of the chosen type in a 15-foot cone, dealing 3d6 damage.",
    classes: ["sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "6 hours",
    description:
      "You and up to eight willing creatures within range fall unconscious for the spell's duration and experience visions of another world. If the spell reaches its full duration, the visions conclude, and everyone affected by the spell awakens in the world chosen for the spell, transported safely to a location there.",
    classes: ["bard", "sorcerer", "warlock", "wizard"],
    source: "Tasha's Cauldron of Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "Choose an unoccupied 5-foot cube of air that you can see within range. An elemental force that resembles a dust devil appears in the cube and lasts for the spell's duration. Any creature that ends its turn within 5 feet of the dust devil must make a Strength saving throw or take 1d8 bludgeoning damage and be pushed 10 feet away.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "Choose one creature you can see within range. Yellow strips of magical energy loop around the creature. The target must succeed on a Strength saving throw, or its flying speed (if any) is reduced to 0 feet for the spell's duration. An airborne creature affected by this spell safely descends at 60 feet per round until it reaches the ground.",
    classes: ["druid", "sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "Choose one creature you can see within range, and choose one of the following damage types: acid, cold, fire, lightning, or thunder. The target must succeed on a Constitution saving throw or lose resistance to that damage type until the spell ends, and the first time it takes damage of that type on a turn, it takes an extra 2d6 damage of that type.",
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "You reach into the mind of one creature you can see and force it to make an Intelligence saving throw. On a failed save, the target loses the ability to distinguish friend from foe, regarding all creatures it can see as enemies until the spell ends.",
    classes: ["bard", "sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You summon a spirit that assumes the form of a loyal, majestic mount. Appearing in an unoccupied space within range, the spirit takes on a form that you choose: a griffon, a pegasus, a peryton, a dire wolf, a rhinoceros, or a saber-toothed tiger.",
    classes: ["paladin"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 hour",
    description:
      "You touch a quiver containing arrows or bolts. When a target is hit by a ranged weapon attack using a piece of ammunition drawn from the quiver, the target takes an extra 1d6 fire damage. The spell's magic ends on the piece of ammunition when it hits or misses.",
    classes: ["artificer", "druid", "ranger", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration:
      "Until dispelled or triggered You inscribe a glyph that later unleashes a magical effect.",
    description:
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "A nature spirit answers your call and transforms you into a powerful guardian. Choose one of the following forms: Primal Beast or Great Tree.",
    classes: ["druid", "ranger"],
    source: "System Reference Document",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You seize the air and compel it to create one of the following effects at a point you can see within range: push a Medium or smaller creature 5 feet, push an object 10 feet, or create a harmless sensory effect.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "System Reference Document",
  },
  {
  ...
  },
  {
    ...
    school: "Conjuration",
    castingTime:
      "1 bonus action, which you take immediately after hitting a creature with a Ranged weapon",
    range: "Self",
    components: "V",
    duration: "Instantaneous",
    description:
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You summon a special homunculus in an unoccupied space within range. This creature uses the Homunculus Servant stat block.",
    classes: ["artificer"],
    source: "System Reference Document",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 10 minutes",
    description:
      "Flames race across your body, shedding bright light in a 30-foot radius and dim light for an additional 30 feet for the spell's duration. The flames don't harm you. You are immune to fire damage and have resistance to cold damage.",
    classes: ["druid", "sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
    ...
    duration: "Concentration, up to 10 minutes",
    description:
      "Until the spell ends, ice rimes your body, and you gain the following benefits: You are immune to cold damage and have resistance to fire damage. You can move across difficult terrain created by ice or snow without spending extra movement.",
    classes: ["druid", "sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    school: "Transmutation",
    castingTime:
      "1 bonus action, which you can take immediately after hitting or missing a target with a ranged attack using a weapon",
    range: "Self",
    components: "V, S",
    duration: "Instantaneous",
    description:
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You create a lash of lightning energy that strikes at one creature of your choice that you can see within range. The target must succeed on a Strength saving throw or be pulled up to 10 feet in a straight line toward you and then take 1d8 lightning damage if it is within 5 feet of you. This spell's damage increases when you reach certain levels.",
    classes: ["artificer", "sorcerer", "warlock", "wizard"],
    source: "Tasha's Cauldron of Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 hour",
    description:
      "You transform up to ten creatures of your choice that you can see within range. An unwilling target must succeed on a Wisdom saving throw to resist the transformation. You can transform each target into a beast or transform the target into a creature of the same challenge rating or lower.",
    classes: ["bard", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous or 1 hour",
    description:
      "You choose a portion of dirt or stone that you can see within range and that fits within a 5-foot cube. You manipulate it in one of the following ways: excavate loose earth, cause shapes or colors to appear on the dirt, or cause the ground to become difficult terrain.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You send ribbons of negative energy at one creature you can see within range. Unless the target is undead, it must make a Constitution saving throw, taking 5d12 necrotic damage on a failed save, or half as much damage on a successful one. A target killed by this damage rises up as a zombie at the start of your next turn. If you target an undead, it doesn't make a saving throw, but instead rolls 5d12 and gains half that many temporary hit points.",
    classes: ["warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    range: "Touch",
    components:
      "V, S, M (a forked, metal rod worth 250+ GP and attuned to a particular plane of existence)",
    duration: "Instantaneous",
    description:
  ...
  },
  {
    ...
    duration: "Instantaneous or 1 hour",
    description:
      "You choose an area of water that you can see within range and that fits within a 5-foot cube. You manipulate it in one of the following ways: move or change the flow of the water, cause the water to form into simple shapes, change the water's color or opacity, or freeze the water.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 10 minutes",
    description:
      "Dim, greenish light spreads within a 30-foot-radius sphere centered on a point you choose within range. The light spreads around corners, and it lasts until the spell ends. When a creature moves into the spell's area for the first time on a turn or starts its turn there, that creature must succeed on a Constitution saving throw or take 4d10 radiant damage, and it suffers one level of exhaustion and emits a dim, greenish light in a 5-foot radius.",
    classes: ["sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    classes: ["concentration", "druid", "sorcerer", "wizard"],
    source: "Player's Handbook (2024)",
  },
  {
    id: "slow",
  ...
  },
  {
    ...
    duration: "8 hours",
    description:
      "As you cast this spell, you use the rope to create a circle with a 5-foot radius on the ground or the floor. When you finish casting, the rope disappears and the circle becomes a magic trap. When a Small, Medium, or Large creature moves into the area, the creature must succeed on a Dexterity saving throw or be magically hoisted into the air and restrained.",
  ...
  },
  {
    ...
    duration: "8 hours",
    description:
      "This spell snatches the soul of a humanoid as it dies and traps it inside the tiny cage you use for the material component. While the soul is trapped, the dead humanoid can't be revived. You can exploit the soul up to six times for various benefits: Steal Life, Query Soul, Borrow Experience, or Eyes of the Dead.",
    classes: ["warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "You call forth spirits of the dead, which flit around you for the spell's duration. Until the spell ends, any attack you make deals 1d8 extra damage when you hit a creature within 10 feet of you. This damage is radiant, necrotic, or cold (your choice). Any creature that takes this damage can't regain hit points until the start of your next turn. In addition, any creature of your choice that you can see that starts its turn within 10 feet of you has its speed reduced by 10 feet until the start of your next turn.",
    classes: ["cleric", "paladin", "warlock", "wizard"],
    source: "Tasha's Cauldron of Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "A 20-foot-radius sphere of whirling air springs into existence centered on a point you choose within range. Each creature in the sphere when it appears or that ends its turn there must succeed on a Strength saving throw or take 2d6 bludgeoning damage. As a bonus action, you can cause a bolt of lightning to leap from the center of the sphere toward one creature you choose within 60 feet of the center. Make a ranged spell attack. You have advantage on the attack roll if the target is in the sphere. On a hit, the target takes 4d6 lightning damage.",
    classes: ["sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 hour",
    description:
      "You utter foul words, summoning one demon from the chaos of the Abyss. You choose the demon's type, which must be one of challenge rating 5 or lower. The demon appears in an unoccupied space you can see within range. The demon disappears when it drops to 0 hit points or when the spell ends.",
    classes: ["warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
    ...
    duration: "Concentration, up to 1 hour",
    description:
      "You utter foul words, summoning demons from the chaos of the Abyss. You roll on the following table to determine what appears: 2 demons of CR 1 or lower, 4 demons of CR 1/2 or lower, or 8 demons of CR 1/4 or lower. The demons appear in unoccupied spaces you can see within range. They are hostile to all creatures, including you.",
    classes: ["warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You create a momentary circle of spectral blades that sweep around you. All other creatures within 5 feet of you must succeed on a Dexterity saving throw or take 1d6 force damage. This spell's damage increases when you reach certain levels.",
    classes: ["artificer", "sorcerer", "warlock", "wizard"],
    source: "Tasha's Cauldron of Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You teleport yourself to an unoccupied space you can see within range. Immediately after you disappear, a thunderous boom sounds, and each creature within 10 feet of the space you left must make a Constitution saving throw, taking 3d10 thunder damage on a failed save, or half as much damage on a successful one. You can bring along objects as long as their weight doesn't exceed what you can carry. You can also bring one willing creature of your size or smaller.",
    classes: ["sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "8 hours",
    description:
      "You touch one Tiny, nonmagical object that isn't attached to another object or a surface and isn't being carried by another creature. The target animates and sprouts little arms and legs, becoming a creature under your control until the spell ends or until it is reduced to 0 hit points. It uses the Tiny Servant stat block.",
  ...
  },
  {
    ...
    duration: "Instantaneous",
    description:
      "You choose an area of stone or mud that you can see that fits within a 40-foot cube and is within range, and choose one of the following effects. Transmute Rock to Mud: Nonmagical rock in the area becomes an equal volume of thick, flowing mud. Transmute Mud to Rock: Nonmagical mud or quicksand in the area no more than 10 feet deep transforms into soft stone for the spell's duration.",
  ...
  },
  {
    ...
    duration: "Concentration, up to 10 minutes",
    description:
      "A gleaming wall of bright light appears at a point you choose within range. You can make the wall up to 60 feet long, 10 feet high, and 5 feet thick. The wall provides bright light for 120 feet and dim light for an additional 120 feet. When the wall appears, each creature in its area must make a Constitution saving throw. On a failed save, a creature takes 4d8 radiant damage, and it is blinded for 1 minute. On a successful save, it takes half as much damage and isn't blinded.",
    classes: ["sorcerer", "warlock", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 10 minutes",
    description:
      "You conjure up a wall of water on the ground at a point you can see within range. You can make the wall up to 30 feet long, 10 feet high, and 1 foot thick, or you can make a ringed wall up to 20 feet in diameter, 20 feet high, and 1 foot thick. The wall vanishes when the spell ends. The wall's space is difficult terrain. Any ranged weapon attack that enters the wall's space has disadvantage on the attack roll.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "A whirlwind howls down to a point that you can see on the ground within range. The whirlwind is a 10-foot-radius, 30-foot-high cylinder that becomes a 30-foot-radius at the top. Until the spell ends, you can use your action to move the whirlwind up to 30 feet in any direction along the ground. When the whirlwind appears, each creature in its area must make a Strength saving throw. On a failed save, a creature takes 10d6 bludgeoning damage and is restrained in the whirlwind.",
    classes: ["druid", "sorcerer", "wizard"],
    source: "Xanathar's Guide to Everything",
  },
  {
  ...
  },
  {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "You call out to the spirits of nature to rouse them against your enemies. Choose a point you can see within range. The spirits cause trees, rocks, and grass in a 60-foot cube centered on that point to become animated until the spell ends. Grass and Undergrowth: Any area of ground in the cube that is covered by grass or undergrowth is difficult terrain. Trees: At the start of each of your turns, each of your enemies within 10 feet of any tree in the cube must succeed on a Dexterity saving throw or take 4d6 slashing damage. Roots and Vines: At the end of each of your turns, one creature of your choice that is on the ground in the cube must succeed on a Strength saving throw or become restrained. Rocks: As a bonus action on your turn, you can cause a loose rock in the cube to launch at a creature you can see in the cube. Make a ranged spell attack. On a hit, the target takes 3d8 nonmagical bludgeoning damage.",
    classes: ["druid", "ranger"],
    source: "Xanathar's Guide to Everything",
  },
  {
